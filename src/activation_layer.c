...
layer make_activation_layer(int batch, int inputs, ACTIVATION activation)
{
    ...
    l.gpu_load = gpu_load_activation_layer;
    l.gpu_unload = gpu_unload_activation_layer;
#endif
...
void gpu_unload_activation_layer(layer l,network n) {
    pull_activation_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
}

void gpu_load_activation_layer(layer l,network n) {
