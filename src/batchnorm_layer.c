...
layer make_batchnorm_layer(int batch, int w, int h, int c)
{
    ...
    l.gpu_load = gpu_load_batchnorm_layer;
    l.gpu_unload = gpu_unload_batchnorm_layer;
...
{
    cuda_pull_array(l.output_gpu, l.output, l.h*l.w*l.c*l.batch);
    cuda_pull_array(l.delta_gpu, l.delta, l.h*l.w*l.c*l.batch);
    
    cuda_pull_array(l.biases_gpu, l.biases, l.c);
    cuda_pull_array(l.bias_updates_gpu, l.bias_updates, l.c);

    cuda_pull_array(l.scales_gpu, l.scales, l.c);
    cuda_pull_array(l.scale_updates_gpu, l.scale_updates, l.c);

    cuda_pull_array(l.mean_gpu, l.mean, l.c);
    cuda_pull_array(l.variance_gpu, l.variance, l.c);

    cuda_pull_array(l.rolling_mean_gpu, l.rolling_mean, l.c);
    cuda_pull_array(l.rolling_variance_gpu, l.rolling_variance, l.c);

    cuda_pull_array(l.mean_delta_gpu, l.mean, l.c);
    cuda_pull_array(l.variance_delta_gpu, l.variance, l.c);

    cuda_pull_array(l.x_gpu, l.output, l.batch*l.outputs);
    cuda_pull_array(l.x_norm_gpu, l.output, l.batch*l.outputs);
}

void gpu_unload_batchnorm_layer(layer l, network net) {
...
void gpu_load_batchnorm_layer(layer l, network net) {
  
    l.output_gpu =  cuda_make_array(l.output, l.h*l.w*l.c*l.batch);
    l.delta_gpu =   cuda_make_array(l.delta, l.h*l.w*l.c*l.batch);

    l.biases_gpu = cuda_make_array(l.biases, l.c);
    l.bias_updates_gpu = cuda_make_array(l.bias_updates, l.c);

    l.scales_gpu = cuda_make_array(l.scales, l.c);
    l.scale_updates_gpu = cuda_make_array(l.scale_updates, l.c);

    l.mean_gpu = cuda_make_array(l.mean, l.c);
    l.variance_gpu = cuda_make_array(l.variance, l.c);

    l.rolling_mean_gpu = cuda_make_array(l.mean, l.c);
    l.rolling_variance_gpu = cuda_make_array(l.variance, l.c);

    l.mean_delta_gpu = cuda_make_array(l.mean, l.c);
    l.variance_delta_gpu = cuda_make_array(l.variance, l.c);
