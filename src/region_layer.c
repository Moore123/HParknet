...
layer make_region_layer(int batch, int w, int h, int n, int classes, int coords)
{
    ...
    l.gpu_load = gpu_load_region_layer;
    l.gpu_unload = gpu_unload_region_layer;
...
void pull_region_layer(layer l)
{
...
void gpu_unload_region_layer(layer l, network net)
{
    pull_region_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
...
void push_region_layer(layer l)
{
    cuda_push_array(l.delta_gpu, l.delta, l.batch*l.inputs);
    cuda_push_array(l.output_gpu, l.output, l.batch*l.inputs);
}

void gpu_load_region_layer(layer l, network net)
{
    l.output_gpu  = cuda_make_array(l.output, l.batch*l.outputs);
    l.delta_gpu   = cuda_make_array(l.delta, l.batch*l.outputs);
}
