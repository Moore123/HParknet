...
void gpu_unload_connected_layer(layer l, network net) {
    ...
    if (net.adam) {
		cuda_pull_array(l.m_gpu, l.m, l.inputs* l.outputs);
		cuda_pull_array(l.v_gpu, l.v, l.inputs* l.outputs);
		cuda_pull_array(l.bias_m_gpu, l.bias_m,  l.outputs);
		cuda_pull_array(l.bias_v_gpu, l.bias_v,  l.outputs);
		cuda_pull_array(l.scale_m_gpu ,l.scale_m,  l.outputs);
		cuda_pull_array(l.scale_v_gpu ,l.scale_v,  l.outputs);
	 }
	
   if(l.batch_normalize){
		cuda_pull_array(l.mean_gpu ,l.mean,  l.outputs);
		cuda_pull_array(l.variance_gpu ,l.variance,  l.outputs);
	
		cuda_pull_array(l.rolling_mean_gpu ,l.mean,  l.outputs);
		cuda_pull_array(l.rolling_variance_gpu ,l.variance,  l.outputs);

		cuda_pull_array(l.mean_delta_gpu ,l.mean,  l.outputs);
		cuda_pull_array(l.variance_delta_gpu ,l.variance,  l.outputs);
...
void gpu_load_connected_layer(layer l,network net) {
    l.weights_gpu = cuda_make_array(l.weights, l.outputs*l.inputs);
    l.biases_gpu = cuda_make_array(l.biases, l.outputs);

    l.weight_updates_gpu = cuda_make_array(l.weight_updates, l.outputs*l.inputs);
    l.bias_updates_gpu = cuda_make_array(l.bias_updates, l.outputs);

    l.output_gpu = cuda_make_array(l.output,  l.outputs*l.batch);
    l.delta_gpu = cuda_make_array(l.delta,  l.outputs*l.batch);
    if (net.adam) {
        l.m_gpu =       cuda_make_array(l.m, l.inputs* l.outputs);
        l.v_gpu =       cuda_make_array(l.v, l.inputs* l.outputs);
        l.bias_m_gpu =  cuda_make_array(l.bias_m,  l.outputs);
        l.bias_v_gpu =  cuda_make_array(l.bias_v,  l.outputs);
        l.scale_m_gpu = cuda_make_array(l.scale_m,  l.outputs);
        l.scale_v_gpu = cuda_make_array(l.scale_v,  l.outputs);
    }

    if(l.batch_normalize){
        l.mean_gpu = cuda_make_array(l.mean,  l.outputs);
        l.variance_gpu = cuda_make_array(l.variance,  l.outputs);

        l.rolling_mean_gpu = cuda_make_array(l.mean,  l.outputs);
        l.rolling_variance_gpu = cuda_make_array(l.variance,  l.outputs);

        l.mean_delta_gpu = cuda_make_array(l.mean,  l.outputs);
        l.variance_delta_gpu = cuda_make_array(l.variance,  l.outputs);

        l.scales_gpu = cuda_make_array(l.scales,  l.outputs);
        l.scale_updates_gpu = cuda_make_array(l.scale_updates,  l.outputs);
