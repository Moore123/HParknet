...
extern "C" void pull_maxpool_layer(layer l)
{
    cuda_pull_int_array(l.indexes_gpu, l.indexes, l.batch*l.inputs);
    cuda_pull_array(l.delta_gpu, l.delta, l.batch*l.inputs);
    cuda_pull_array(l.output_gpu, l.output, l.batch*l.inputs);
}


extern "C" void gpu_unload_maxpool_layer(layer l, network net)
{
    pull_maxpool_layer(l);
    cuda_free((float *)l.indexes_gpu);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
}

extern "C" void push_maxpool_layer(layer l)
{
    cuda_push_int_array(l.indexes_gpu, l.indexes, l.batch*l.outputs);
    cuda_push_array(l.delta_gpu, l.delta, l.batch*l.outputs);
    cuda_push_array(l.output_gpu, l.output, l.batch*l.outputs);
}

extern "C" void gpu_load_maxpool_layer(layer l, network net)
{
