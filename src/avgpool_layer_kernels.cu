...
extern "C" void pull_avgpool_layer(layer l)
{
    cuda_pull_array(l.delta_gpu, l.delta, l.outputs*l.batch);
    cuda_pull_array(l.output_gpu, l.output, l.outputs*l.batch);
}

extern "C" void gpu_unload_avgpool_layer(layer l, network net) {
    pull_avgpool_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
}

extern "C" void gpu_load_avgpool_layer(layer l, network net) {
