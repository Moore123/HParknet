...
extern "C" void pull_crop_layer(layer l)
{
    cuda_pull_array(l.rand_gpu, l.rand, l.batch*8);
    cuda_pull_array(l.output_gpu, l.output, l.outputs*l.batch);
}

extern "C" void gpu_unload_crop_layer(layer l, network net) {
    pull_crop_layer(l);
    cuda_free(l.rand_gpu);
    cuda_free(l.output_gpu);
}

extern "C" void gpu_load_crop_layer(layer l, network net) {
    l.output_gpu = cuda_make_array(l.output, l.outputs*l.batch);
    l.rand_gpu   = cuda_make_array(l.rand, l.batch*8);
}
