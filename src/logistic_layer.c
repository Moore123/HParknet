...
layer make_logistic_layer(int batch, int inputs)
{
    ...
    l.gpu_load = gpu_load_logistic_layer;
    l.gpu_unload = gpu_unload_logistic_layer;
...
void pull_logistic_layer(layer l)
{
...
void gpu_unload_logistic_layer(layer l, network net)
{
    pull_logistic_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.loss_gpu);
    cuda_free(l.output_gpu);
}

void push_logistic_layer(layer l)
{
    cuda_push_array(l.delta_gpu, l.delta, l.batch*l.inputs);
    cuda_push_array(l.loss_gpu, l.loss, l.batch*l.inputs);
    cuda_push_array(l.output_gpu, l.output, l.batch*l.inputs);
}

void gpu_load_logistic_layer(layer l, network net)
{
    l.loss_gpu = cuda_make_array(l.loss, l.batch*l.outputs);
