...
extern "C" void gpu_load_convolutional_layer(layer l, network net) {
...
extern "C" void gpu_unload_convolutional_layer(layer l, network net) 
{
    cuda_pull_array(l.weights_gpu, l.weights, l.nweights);
    cuda_pull_array(l.weight_updates_gpu, l.weight_updates, l.nweights);
    cuda_pull_array(l.biases_gpu, l.biases, l.n);
    cuda_pull_array(l.bias_updates_gpu, l.bias_updates, l.n);
    cuda_pull_array(l.delta_gpu, l.delta, l.batch*l.out_h*l.out_w*l.n);
    cuda_pull_array(l.output_gpu, l.output, l.batch*l.out_h*l.out_w*l.n);

        if(l.binary){
            cuda_pull_array(l.binary_weights_gpu, l.weights, l.nweights);
        }
        if(l.xnor){
            cuda_pull_array(l.binary_weights_gpu, l.weights, l.nweights);
            cuda_pull_array(l.binary_input_gpu, l.binary_input, l.inputs*l.batch);
        }

        if(l.batch_normalize){
            cuda_pull_array(l.mean_gpu, l.mean, l.n);
            cuda_pull_array(l.variance_gpu, l.variance, l.n);

            cuda_pull_array(l.rolling_mean_gpu, l.mean, l.n);
            cuda_pull_array(l.rolling_variance_gpu, l.variance, l.n);

            cuda_pull_array(l.mean_delta_gpu, l.mean, l.n);
            cuda_pull_array(l.variance_delta_gpu, l.variance, l.n);

            cuda_pull_array(l.scales_gpu, l.scales, l.n);
            cuda_pull_array(l.scale_updates_gpu, l.scale_updates, l.n);

            cuda_pull_array(l.x_gpu, l.output, l.batch*l.out_h*l.out_w*l.n);
            cuda_pull_array(l.x_norm_gpu, l.output, l.batch*l.out_h*l.out_w*l.n);
        }
