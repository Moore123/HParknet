...
local_layer make_local_layer(int batch, int h, int w, int c, int n, int size, int stride, int pad, ACTIVATION activation)
{
    ...
    l.gpu_load = gpu_load_local_layer;
    l.gpu_unload = gpu_unload_local_layer;
...
void gpu_load_local_layer(local_layer l, network net) {

    int locations = l.out_h * l.out_w;
    l.weights_gpu = cuda_make_array(l.weights, l.c*l.n*l.size*l.size*locations);
    l.weight_updates_gpu = cuda_make_array(l.weight_updates, l.c*l.n*l.size*l.size*locations);
...
void gpu_unload_local_layer(local_layer l, network net) {

    int locations = l.out_h * l.out_w;
    cuda_pull_array(l.weights_gpu, l.weights, l.c*l.n*l.size*l.size*locations);
    cuda_pull_array(l.weight_updates_gpu, l.weight_updates, l.c*l.n*l.size*l.size*locations);
