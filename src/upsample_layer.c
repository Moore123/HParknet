...
layer make_upsample_layer(int batch, int w, int h, int c, int stride)
{
    ...
    l.gpu_load = gpu_load_upsample_layer;
    l.gpu_unload = gpu_unload_upsample_layer;
...
void pull_upsample_layer(layer l)
{
...
void gpu_unload_upsample_layer(layer l, network net)
{
    pull_upsample_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
}

void push_upsample_layer(layer l)
{
    cuda_push_array(l.delta_gpu, l.delta, l.batch*l.outputs);
    cuda_push_array(l.output_gpu, l.output, l.batch*l.outputs);
}

void gpu_load_upsample_layer(layer l, network net)
{
