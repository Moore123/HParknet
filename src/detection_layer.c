...
detection_layer make_detection_layer(int batch, int inputs, int n, int side, int classes, int coords, int rescore)
{
    ...
    l.gpu_load = gpu_load_detection_layer;
    l.gpu_unload = gpu_unload_detection_layer;
...
void pull_detection_layer(layer l)
{
    cuda_pull_array(l.delta_gpu, l.delta, l.outputs*l.batch);
    cuda_pull_array(l.output_gpu, l.output, l.outputs*l.batch);
}

void gpu_unload_detection_layer(layer l, network net) {
    pull_detection_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
}

void gpu_load_detection_layer(layer l, network net) {
