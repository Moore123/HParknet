...
route_layer make_route_layer(int batch, int n, int *input_layers, int *input_sizes)
{
    ...
    l.gpu_load = gpu_load_route_layer;
    l.gpu_unload = gpu_unload_route_layer;
...
void gpu_unload_route_layer(layer l, network net)
{
    pull_route_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
...
void gpu_load_route_layer(layer l, network net)
{
