...
layer make_l2norm_layer(int batch, int inputs)
{
    ...
    l.gpu_load = gpu_load_l2norm_layer;
    l.gpu_unload = gpu_unload_l2norm_layer;
...
void pull_l2norm_layer(layer l)
{
    cuda_pull_array(l.delta_gpu, l.delta, l.batch*l.inputs);
    cuda_pull_array(l.scales_gpu, l.scales, l.batch*l.inputs);
    cuda_pull_array(l.output_gpu, l.output, l.batch*l.inputs);
}


void gpu_unload_l2norm_layer(layer l, network net)
{
    pull_l2norm_layer(l);
...
void push_l2norm_layer(layer l)
{
    cuda_push_array(l.delta_gpu, l.delta, l.batch*l.inputs);
    cuda_push_array(l.scales_gpu, l.scales, l.batch*l.inputs);
    cuda_push_array(l.output_gpu, l.output, l.batch*l.inputs);
}

void gpu_load_l2norm_layer(layer l, network net)
{
    l.scales_gpu = cuda_make_array(l.scales, l.batch*l.inputs);
