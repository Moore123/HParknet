...
cost_layer make_cost_layer(int batch, int inputs, COST_TYPE cost_type, float scale)
{
    ...
    l.gpu_load = gpu_load_cost_layer;
    l.gpu_unload = gpu_unload_cost_layer;
...
void gpu_unload_cost_layer(cost_layer l,network net)
{
    pull_cost_layer(l);
    cuda_free(l.delta_gpu);
    cuda_free(l.output_gpu);
...
void gpu_load_cost_layer(cost_layer l, network net)
{
