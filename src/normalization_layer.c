...
layer make_normalization_layer(int batch, int w, int h, int c, int size, float alpha, float beta, float kappa)
{
    ...
    layer.gpu_load = gpu_load_normalization_layer;
    layer.gpu_unload = gpu_unload_normalization_layer;
...
void gpu_unload_normalization_layer(layer l, network net) {
    cuda_pull_array(l.delta_gpu, l.delta, l.out_h * l.out_w * l.out_c * l.batch);
    cuda_pull_array(l.output_gpu, l.output, l.out_h * l.out_w * l.out_c * l.batch);
    cuda_pull_array(l.squared_gpu, l.squared, l.out_h * l.out_w * l.out_c * l.batch);
    cuda_pull_array(l.norms_gpu, l.norms, l.out_h * l.out_w * l.out_c * l.batch);
...
void gpu_load_normalization_layer(layer l, network net) {
    l.output_gpu =  cuda_make_array(l.output, l.out_h * l.out_w * l.out_c * l.batch);
    l.delta_gpu =   cuda_make_array(l.delta, l.out_h * l.out_w * l.out_c * l.batch);
    l.squared_gpu = cuda_make_array(l.squared, l.out_h * l.out_w * l.out_c * l.batch);
    l.norms_gpu =   cuda_make_array(l.norms, l.out_h * l.out_w * l.out_c * l.batch);
}
#endif
